...
class Payment(models.Model):
    ...
    payment_method = models.CharField(max_length=150, choices=[('cach', 'Cach'), ('transfer', 'Transfer')], verbose_name='payment_method')
    ...
    stripe_id = models.CharField(max_length=300, verbose_name='stripe_id')
